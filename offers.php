...
<div class="container" style="margin-top: 100px;">
    <h1 style="text-align: center; color:rgba(177, 34, 34, 0.877); ;">Offers%</h1>
    <img style="margin-right: 15px;" src="images/offerimage.jpg">  <img src="images/offerimage.jpg"> <br>
    <p><b>USE CODE:SAFETRAVEL</b> </p>                    <p style="margin-left: 520px; margin-top: -40px;"><b>USE CODE:SAFETRAVEL</b> </p>    
    <img style="margin-top: 15px; margin-right: 15px;" src="images/offerimage.jpg">  <img  style="margin-top: 15px;" src="images/offerimage.jpg"> <br>
    <p><b>USE CODE:SAFETRAVEL</b> </p>                    <p style="margin-left: 520px; margin-top: -40px;"><b>USE CODE:SAFETRAVEL</b> </p>
    <img style="margin-right: 15px; margin-top: 15px;" src="images/offerimage.jpg">  <img style="margin-top: 15px;" src="images/offerimage.jpg"> <br>
    <p><b>USE CODE:SAFETRAVEL</b> </p>                    <p style="margin-left: 520px; margin-top: -40px;"><b>USE CODE:SAFETRAVEL</b> </p>
</div>
